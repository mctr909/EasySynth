...
namespace EasySynth.Forms
{
	partial class PianoRoll
	{
		...
		private void InitializeComponent()
		{
			...
			this.編集対象_エクスプレッション = new System.Windows.Forms.ToolStripMenuItem();
			...
			this.PicInput.Location = new System.Drawing.Point(159, 126);
			...
			// 編集対象_エクスプレッション
			// 
			this.編集対象_エクスプレッション.Image = global::EasySynth.Properties.Resources.edit_exp;
			this.編集対象_エクスプレッション.ImageScaling = System.Windows.Forms.ToolStripItemImageScaling.None;
			this.編集対象_エクスプレッション.Name = "編集対象_エクスプレッション";
			this.編集対象_エクスプレッション.ShortcutKeys = System.Windows.Forms.Keys.F3;
			this.編集対象_エクスプレッション.Size = new System.Drawing.Size(180, 30);
			this.編集対象_エクスプレッション.Text = "エクスプレッション";
			this.編集対象_エクスプレッション.Click += new System.EventHandler(this.編集対象_Click);
			// 
			// 編集対象_ピッチ
			// 
		...
		private System.Windows.Forms.ToolStripMenuItem 編集対象_エクスプレッション;
